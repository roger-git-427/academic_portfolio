...
# final_tca_pipeline_reto documentation build
...
from final_tca_pipeline_reto import __version__ as release

# -- Project information -----------------------------------------------------

project = "final_tca_pipeline_reto"
author = "Kedro"
...
htmlhelp_basename = "final_tca_pipeline_retodoc"
...
latex_documents = [
    (
        master_doc,
        "final_tca_pipeline_reto.tex",
        "final_tca_pipeline_reto Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "final_tca_pipeline_reto",
        "Project final_tca_pipeline_reto codebase.",
        "Data-Science",
    )
]
